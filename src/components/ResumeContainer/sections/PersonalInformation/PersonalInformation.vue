<template>
  <Section title="Personal Details">
    <div class="default-slot">
      ...
      <div class="row">
        <div class="col">
          <TextInput v-model="values.email" label="Email" type="email" />
        </div>
        <div class="col">
      ...
      <div class="row">
        <div class="col">
          <TextInput
            ...
            tooltip="Include this section if your profession requires a certain type of license. If not, leave it blank."
